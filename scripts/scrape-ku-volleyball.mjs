...
import { parseSchedule } from './schedule-parser.mjs';
...
try {
  ...
  // Parsed by scripts/schedule-parser.mjs, which is tested against a saved page.
  const uniqueUpcoming = parseSchedule(schedText, { stripRank, postalCity });
